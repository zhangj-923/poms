    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" id="content" name="content" required
               autocomplete="off" class="layui-input" placeholder="" lay-verify="required" disabled>
      </div>
    </div>
    <div class="layui-form-item">
      <label for="repair_remark" class="layui-form-label">
        <span class="x-red">*</span>报修备注
      </label>
      <div class="layui-input-inline">
        <input type="text" id="repair_remark" name="repair_remark" required
               autocomplete="off" class="layui-input" placeholder="输入单价" lay-verify="required" disabled>
      </div>
    </div>
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" id="repair_time" name="repair_time" required
               autocomplete="off" class="layui-input" placeholder="输入初始读数" lay-verify="required" disabled>
      </div>
    </div>
    <div class="layui-form-item">
      <label for="deal_content" class="layui-form-label">
        <span class="x-red">*</span>处理方式
      </label>
      <div class="layui-input-inline">
        <input type="text" id="deal_content" name="deal_content" required
               autocomplete="off" class="layui-input" placeholder="请输入处理方式" lay-verify="required">
      </div>
    </div>
    <div class="layui-form-item">
...
<script>
  layui.use(['form', 'layer', 'laydate'], function () {
    ...
    function getRepairAjax () {
      var repair_id = window.parent.document.getElementById('update_repair_id').value;
      $.ajax({
        url: 'getRepair?repairId=' + repair_id,
        type: 'get',
        dataType: 'json',
        success: function (data) {
          $("#repair_id").val(data.data.repair_id);
          $("#content").val(data.data.content);
          $("#repair_remark").val(data.data.repair_remark);
          $("#repair_time").val(data.data.repair_time);
        }
      });
    }
  });
