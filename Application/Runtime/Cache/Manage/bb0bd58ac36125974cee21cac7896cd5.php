...
<div class="x-body">
    ...
    <div class="demoTable layui-form-item">
      <div class="layui-inline">
        ...
        <div class="layui-input-inline">
          <input class="layui-input" name="search" id="search" placeholder="房间号|租户姓名" autocomplete="off">
        </div>
  ...
  <!--    </button>-->
  <!--  </xblock>-->
  <input type="hidden" id="update_repair_id" value="0">
...
<script>
  layui.use(['table', 'layer', 'form'], function () {
    ...
    table.render({
      elem: '#demo',
      height: 450,
      url: 'getRepairList',  //数据接口
      page: true, //开启分页
      cols: [
        [ //表头
          {fixed: 'left', type: 'checkbox'},
          {field: 'repair_id', width: '5%', title: 'Id', align: 'center', sort: 'true'},
          {field: 'roomInfo', width: '10%', title: '房屋信息', align: 'center', sort: 'true'},
          {field: 'customer_name', width: '5%', title: '租户', align: 'center', sort: 'true'},
          {field: 'customer_mobile', width: '8%', title: '联系方式', align: 'center', sort: 'true'},
          {field: 'status', width: '6%', title: '处理状态', align: 'center', sort: 'true', templet: '#statusTpl'},
          {field: 'content', width: '12%', title: '报修内容', align: 'center', sort: 'true'},
          {field: 'repair_time', width: '9%', title: '报修时间', align: 'center', sort: 'true'},
          {field: 'repair_remark', width: '9%', title: '备注', align: 'center', sort: 'true'},
          {field: 'deal_content', width: '12%', title: '处理结果', align: 'center', sort: 'true'},
    ...
    table.on('tool(test)', function (obj) {
      ...
      if (layEvent === 'del') {
        ...
        //隐藏域存放customer_id
        $('#update_repair_id').val(data.repair_id);
        x_admin_show('处理', 'repair_deal', 600, 500);
      }
    })
  });
</script>
