...
(function ($) {
  ...
  function Scroller(elem, settings) {
    ...
    that.show = function (prevAnim) {
      ...
      var html = '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr"><div class="title">' + s.title + '</div>' + (s.headerText ? '<div class="dwv"></div>' : ''));
      ...
      /*html += (s.display != 'inline' ? '<div class="dwbc"><a class="dwbw dwb-s"><span class="dwb">' + s.setText + '</span></a></div></div>' : '<div class="dwcc"></div>') + '</div></div></div>';*/
